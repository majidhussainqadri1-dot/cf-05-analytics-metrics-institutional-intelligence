# Implementation Status — 1.0.0-rc.10
...
| Coded | Future-40 source expansion committed; governed sequential review/fix rounds are preserved in dedicated round evidence; zero known source defects after governed source QA |
...
Candidate `1.0.0-rc.10`; schema `1.4.1`; contract `1.4.0`; runtime default `foundation_disabled`.
