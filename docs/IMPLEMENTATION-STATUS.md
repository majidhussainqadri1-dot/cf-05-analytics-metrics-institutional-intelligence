# Implementation Status — 1.0.0-rc.9
...
| Coded | Future-40 source expansion committed; fifty fresh review/fix rounds are now preserved; zero known source defects after governed source QA |
...
Candidate `1.0.0-rc.9`; schema `1.4.1`; contract `1.4.0`; runtime default `foundation_disabled`.
