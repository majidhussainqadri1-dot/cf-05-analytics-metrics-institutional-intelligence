...
sbom={'bomFormat':'CycloneDX','specVersion':'1.5','serialNumber':'urn:uuid:cf05-analytics-1-0-0-rc-9','version':1,'metadata':{'component':{'type':'application','name':slug,'version':version}},'components':components}
(dist/f'CF-05-{version}-sbom.cdx.json').write_text(json.dumps(sbom,indent=2,ensure_ascii=False)+'\n',encoding='utf-8')
evidence={'module':'CF-05','version':version,'schema_version':'1.4.1','contract_version':'1.4.0','archive':archive.name,'sha256':sha,'file_count':len(files),'review_rounds_completed':50,'future40_features_coded':40,'deterministic_timestamp':'2026-08-06T00:00:00Z','staging_accepted':False,'live_deployed':False,'operational':False}
