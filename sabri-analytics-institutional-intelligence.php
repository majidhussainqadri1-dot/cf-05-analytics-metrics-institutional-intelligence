 ...
 * Description: Governed, privacy-safe analytics warehouse, semantic metrics, institutional reports, experiments and decision-support infrastructure for the Sabri Social Homeopathy Platform.
 * Version:     1.0.0-rc.1
...
define('SMAI_VERSION', '1.0.0-rc.1');
define('SMAI_SCHEMA_VERSION', '1.0.0');
define('SMAI_CONTRACT_VERSION', '1.1.0');
...
register_activation_hook(__FILE__, [Sabri\AnalyticsIntelligence\Infrastructure\SchemaUpgrade::class, 'install']);
