 ...
 * Description: Conditional, privacy-safe event governance, metric catalog, aggregate institutional intelligence and decision-support infrastructure for the Sabri Social Homeopathy Platform.
 * Version:     0.1.0
...
define('SMAI_VERSION', '0.1.0');
define('SMAI_SCHEMA_VERSION', '0.2.0');
define('SMAI_CONTRACT_VERSION', '1.0.0');
